...
import org.promasi.coredesigner.figure.SdStockFigure;
...
/**
 * Represents the controller between the SdStock model and the SdStockFigure
 * 
 * @author antoxron
 *
 */
public class SdStockEditPart extends AbstractEditPart implements NodeEditPart {

	@Override
	protected IFigure createFigure( ) {
		IFigure figure = new SdStockFigure(); 
		return figure;
	}
	...
	protected void refreshVisuals( ) { 
		SdStockFigure figure = ( SdStockFigure )getFigure(); 
		SdStock model = ( SdStock )getModel(); 
