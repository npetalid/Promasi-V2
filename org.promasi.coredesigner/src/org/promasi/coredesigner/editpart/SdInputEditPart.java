...
import org.promasi.coredesigner.figure.SdInputFigure;
...
/**
 * Represents the controller between the SdInput model and the SdInputFigure
 * 
 * @author antoxron
 *
 */
public class SdInputEditPart extends AbstractEditPart implements NodeEditPart {

	@Override
	protected IFigure createFigure() {
		IFigure figure = new SdInputFigure(); 
		return figure;
	}
	@Override
	...
	protected void refreshVisuals(){ 
		SdInputFigure figure = ( SdInputFigure )getFigure(); 
		SdInput model = ( SdInput )getModel(); 
