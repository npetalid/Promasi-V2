 ...
 * 
 */
public class CalculateEquationDialog extends ApplicationWindow implements
	 ...
	 */
	public CalculateEquationDialog(java.util.List<String> variables,
	...
	protected Control createContents(Composite parent) {
		...
		final ScrolledForm scrolledForm = formToolkit
		...
		Composite topContainer = formToolkit.createComposite(mainSashForm,
				SWT.NONE);
		formToolkit.paintBordersFor(topContainer);
		topContainer.setLayout(new FillLayout(SWT.HORIZONTAL));

		_calculateText = formToolkit.createText(topContainer, "New Text",
				SWT.BORDER | SWT.WRAP | SWT.H_SCROLL | SWT.V_SCROLL
						| SWT.CANCEL | SWT.MULTI);
		_calculateText.setText("");

		Composite bottomContainer = formToolkit.createComposite(mainSashForm,
				SWT.NONE);
		...
		_sevenButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_eightButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_nineButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		GridData gd__plusButton = new GridData(SWT.LEFT, SWT.FILL, false,
				false, 1, 1);
		...
		_fourButton.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false,
				false, 1, 1));
		...
		_fiveButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_sixButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		GridData gd__minButton = new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1);
		...
		_oneButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_twoButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_threeButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_mulButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_zeroButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_eButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false,
				1, 1));
		...
		_dotButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_slashButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_lBracketButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_rBracketButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_commaButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		_powerButton.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		...
		tabFolder.setBackground(ImageUtilities
		...
		_variableList = new List(listContainer, SWT.BORDER | SWT.H_SCROLL
				| SWT.V_SCROLL);
		...
		_functionsList = new List(functionsContainer, SWT.BORDER | SWT.H_SCROLL
				| SWT.V_SCROLL);
	...
	private String buildFunction(String functionName) {
		...
		PostfixMathCommandI function = _jep.getFunctionTable()
				.get(functionName);
		if (function == null) {
